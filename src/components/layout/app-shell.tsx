  ...
  return (
    <div className="flex h-[100dvh] overflow-hidden bg-background text-foreground">
      ...
      <div className="flex flex-col flex-1 md:pl-64 h-full overflow-hidden">
        ...
        />
        <main className="flex-1 overflow-y-auto overflow-x-hidden overscroll-y-contain [touch-action:manipulation] [-webkit-overflow-scrolling:touch] p-4 md:p-6 lg:p-8 flex flex-col justify-between pb-[calc(1.5rem+env(safe-area-inset-bottom,0px))]">
