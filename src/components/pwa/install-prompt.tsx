          ...
          <div className="space-y-4 py-2">
            <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
              ...
              <div className="text-xs text-slate-700 dark:text-slate-300">
                <span className="font-semibold text-slate-900 dark:text-white">Tap the Share button:</span>
                <p className="mt-0.5 text-slate-500 flex items-center gap-1">
                  At the bottom of Safari, tap the <Share className="w-3.5 h-3.5 inline text-blue-500" /> Share icon.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
              ...
              <div className="text-xs text-slate-700 dark:text-slate-300">
                <span className="font-semibold text-slate-900 dark:text-white">Select Add to Home Screen:</span>
                <p className="mt-0.5 text-slate-500 flex items-center gap-1">
                  Scroll down the menu and tap <PlusSquare className="w-3.5 h-3.5 inline text-slate-600" /> &quot;Add to Home Screen&quot;.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
              ...
              <div className="text-xs text-slate-700 dark:text-slate-300">
                <span className="font-semibold text-slate-900 dark:text-white">Confirm by tapping &quot;Add&quot;:</span>
                <p className="mt-0.5 text-slate-500">
                  Tap &quot;Add&quot; in the top-right corner. The app icon will appear instantly on your iPhone screen!
                </p>
              </div>
            </div>
          </div>
